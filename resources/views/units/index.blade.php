<x-app-layout>
    ...
    <section class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <form method="GET" action="{{ route('master-obat.satuan.index') }}" class="mt-6 flex flex-col gap-3 xl:flex-row xl:items-center">
            ...
            <button type="submit" class="shrink-0 rounded-2xl border border-slate-300 px-5 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 xl:min-w-32">Cari</button>
        </form>
