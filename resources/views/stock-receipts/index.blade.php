<x-app-layout>
    <x-slot name="header">Stok Masuk</x-slot>
                    ...
                    <tbody class="divide-y divide-slate-100 bg-white">
                        @forelse ($receipts as $receipt)
                            <tr>
                                ...
                                <td class="px-4 py-3">
                                    <span class="whitespace-nowrap rounded-full px-2.5 py-1 text-xs font-semibold {{ $receipt->status === 'posted' ? 'bg-emerald-100 text-emerald-800' : 'bg-amber-100 text-amber-800' }}">
