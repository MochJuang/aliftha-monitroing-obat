<x-app-layout>
    <x-slot name="header">Laporan Stok Masuk</x-slot>
    ...
    <section class="mt-6 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
        <form method="GET" action="{{ route('reports.receipts') }}" class="grid gap-3 xl:grid-cols-[minmax(0,2fr)_minmax(0,1fr)_180px_180px_180px_140px] xl:items-end">
